		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Data Binding",
									"targetURL": "#databinding01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"databinding01-display": {
								"semanticObject": "databinding01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=databinding01",
									"url": sap.ui.require.toUrl("databinding01")
								}
							}
						}
					}
